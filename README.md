...
git clone https://github.com/yourusername/passmgr.git
cd passmgr
...
If you run passmgr with no arguments, it launches a continuous interactive shell. This allows you to chain commands together seamlessly without having to re-type the program name.
...
**Type passmgr help to see a full list of commands and flags.**
...
This project is licensed under the MIT License - see the LICENSE file for details. Provided "as is" without warranty of any kind.